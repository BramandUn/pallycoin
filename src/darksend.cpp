...
/* *** BEGIN DARKSEND MAGIC - PALLY **********
    Copyright (c) 2014-2015, Pallycoin Developers
        eduffield - evan@bramandun.io
        udjinm6   - udjinm6@bramandun.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Pallycoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("pallycoin-darksend");
