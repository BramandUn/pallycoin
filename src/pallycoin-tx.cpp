...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Pallycoin Core pallycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pallycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pallycoin transaction") + "\n" +
              "  pallycoin-tx [options] -create [commands]   " + _("Create hex-encoded pallycoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pallycoin transaction
