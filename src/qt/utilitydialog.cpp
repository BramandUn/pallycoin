    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Pallycoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Pallycoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pallycoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Pallycoin Core is shutting down...") + "<br /><br />" +
