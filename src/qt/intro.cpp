...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Pallycoin Core"),
     ...
     * override -datadir in the pallycoin.conf file in the default data directory
     * (to be consistent with pallycoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
