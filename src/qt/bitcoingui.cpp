    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Pallycoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pallycoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pallycoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Pallycoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pallycoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pallycoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pallycoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pallycoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a pallycoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pallycoin Core help message to get a list with possible Pallycoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Pallycoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pallycoin network", "", count));
}
...
{
    QString strTitle = tr("Pallycoin Core"); // default title
