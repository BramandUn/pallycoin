...
// Copyright (c) 2014-2015 The Pallycoin Core developers
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9556", "::ffff:127.0.0.1", 9556));
    BOOST_CHECK(TestSplitHost("[::]:9556", "::", 9556));
    BOOST_CHECK(TestSplitHost("::9556", "::9556", -1));
    BOOST_CHECK(TestSplitHost(":9556", "", 9556));
    BOOST_CHECK(TestSplitHost("[]:9556", "", 9556));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9556", "127.0.0.1:9556"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9556", "[::]:9556"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
