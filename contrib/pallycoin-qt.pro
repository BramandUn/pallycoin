...
SOURCES += src/activemasternode.cpp \
           ...
           src/darksend.cpp \
           src/pallycoin-cli.cpp \
           src/pallycoin-tx.cpp \
           src/pallycoind.cpp \
           src/db.cpp \
           ...
           src/qt/pallycoin.cpp \
           src/qt/pallycoinstrings.cpp \
...
RESOURCES += src/qt/pallycoin.qrc src/qt/pallycoin_locale.qrc
TRANSLATIONS += src/qt/locale/pallycoin_bg.ts \
                src/qt/locale/pallycoin_de.ts \
                src/qt/locale/pallycoin_en.ts \
                src/qt/locale/pallycoin_es.ts \
                src/qt/locale/pallycoin_fi.ts \
                src/qt/locale/pallycoin_fr.ts \
                src/qt/locale/pallycoin_it.ts \
                src/qt/locale/pallycoin_ja.ts \
                src/qt/locale/pallycoin_pl.ts \
                src/qt/locale/pallycoin_pt.ts \
                src/qt/locale/pallycoin_ru.ts \
                src/qt/locale/pallycoin_sk.ts \
                src/qt/locale/pallycoin_sv.ts \
                src/qt/locale/pallycoin_vi.ts \
                src/qt/locale/pallycoin_zh_CN.ts \
                src/qt/locale/pallycoin_zh_TW.ts
