...
Only requiring some minor changes is pallycoin.cpp.
...
Changes to pallycoin.cpp
----------------------
pallycoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
